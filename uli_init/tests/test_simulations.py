...
class TestSimulate(BaseTest):
    ...
    def test_quench(self, peek_system):
        ...
        simulation.quench(kT=2, n_steps=1e3, shrink_kT=8, shrink_steps=1e3, shrink_period=1, walls=False)
    ...
    def test_walls_quench(self, peek_system_noH):
        simulation = simulate.Simulation(peek_system_noH, dt = 0.001, mode='cpu')
        simulation.quench(kT=2, n_steps=1e3, shrink_kT=8, shrink_steps=1e3, shrink_period=20,walls=True)
